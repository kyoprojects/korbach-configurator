console.log('execute');
setTimeout(() => {
  const clickSound = new Audio('http://localhost:3030/korbach-configurator/370962__cabled_mess__click-01_minimal-ui-sounds.wav');
  const clickSound2 = new Audio('http://localhost:3030/korbach-configurator/670810__outervo1d__tsa-2.wav');
